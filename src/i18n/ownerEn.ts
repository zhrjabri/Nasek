...
export const ownerEn = {
  ...
  'prov.formIncludedPlaceholder':
    'Enter the services included in this trip, one per line…',
  'prov.formDepartureLocationPlaceholder':
    'For example: Sultan Qaboos Grand Mosque car park – south gate, Muscat',
  'prov.formOfficeNumber': 'Office number (if available)',
  ...
  'prov.errDepartureLocation': 'Enter where the trip departs from.',
