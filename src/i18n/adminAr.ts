...
export const adminAr: Record<AdminMessageKey, string> = {
  ...
  'admin.newOwnerBody':
    'أدخل بيانات الشركة كما وردت في التصريح، وارفع التصريح نفسه، وحدّد البريد الإلكتروني وكلمة المرور المؤقتة اللذين سيدخل بهما صاحب الحملة. يصبح الحساب جاهزاً فوراً — لا تُرسل أي رسالة بريد، فأبلغ صاحب الحملة بكلمة المرور المؤقتة بنفسك.',
  'admin.newOwnerCreate':
    'إنشاء الحساب',
  'admin.newOwnerCreated':
    '{name} جاهز',
  'admin.newOwnerEmailHint':
    'العنوان الذي يسجّل به صاحب الحملة الدخول. لا ترسل ناسِك إليه شيئاً.',
  ...
  'admin.newOwnerCreatedBody':
    'تم إنشاء الحساب {email}. يمكن لصاحب الحملة الدخول الآن من بوابة أصحاب الحملات بهذا البريد وكلمة المرور المؤقتة التي حدّدتها. لم تُرسل أي رسالة بريد — أبلغه بكلمة المرور بشكل خاص.',
  'admin.newOwnerDone':
    'تم',
  ...
  'admin.newOwnerAccountNote':
    'يسجّل صاحب الحملة الدخول بالبريد الإلكتروني أعلاه وكلمة المرور المؤقتة هذه. رقم الهاتف للتواصل وواتساب فقط — ولا يمكن استخدامه لتسجيل الدخول.',
  'admin.newOwnerPassword':
    'كلمة المرور المؤقتة',
  'admin.newOwnerPasswordHint':
    '{n} حرفاً على الأقل. لن تُعرض مرة أخرى بعد إنشاء الحساب.',
  'admin.newOwnerPasswordConfirm':
    'تأكيد كلمة المرور المؤقتة',
  'admin.newOwnerPasswordShort':
    'استخدم {n} حرفاً على الأقل.',
  'admin.newOwnerPasswordLong':
    'كلمة المرور أطول مما تقبله خدمة الدخول. استخدم كلمة أقصر.',
  'admin.newOwnerPasswordSpaces':
    'احذف المسافة في البداية أو النهاية.',
  'admin.newOwnerPasswordSimple':
    'كلمة المرور متكررة جداً. استخدم أحرفاً متنوعة.',
  'admin.newOwnerPasswordIsEmail':
    'لا يمكن أن تكون كلمة المرور هي البريد الإلكتروني.',
  'admin.newOwnerPasswordMismatch':
    'كلمتا المرور غير متطابقتين.',
  'admin.newOwnerWeakPassword':
    'لم تقبل خدمة الدخول كلمة المرور هذه. لم يُنشأ شيء.',
  'admin.newOwnerEmailExists':
    'لهذا البريد الإلكتروني حساب في ناسِك بالفعل. لم يُنشأ شيء — استخدم عنواناً آخر.',
  'admin.newOwnerCreateFailed':
    'تعذّر حفظ الشركة، فحُذف الحساب الجديد مرة أخرى. لم يُحتفظ بشيء.',
  'admin.newOwnerCleanupFailed':
    'تعذّر حفظ الشركة، وتعذّر حذف الحساب الجديد لهذا العنوان تلقائياً. احذفه من Supabase ← Authentication ← Users قبل إعادة المحاولة.',
  'admin.newOwnerUnreachable':
    'لم يستجب الخادم. راجع قائمة أصحاب الحملات قبل إعادة المحاولة — فقد يكون الحساب قد أُنشئ.',
  'admin.newOwnerNoneBody':
    'لا يوجد أصحاب حملات بعد. أضف الأول — تحدّد بريده وكلمة مرور مؤقتة، ويدخل من بوابة أصحاب الحملات.',
